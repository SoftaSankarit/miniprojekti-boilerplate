...
class Reference(db.Model):
    ...
    type_id = db.Column(db.Integer, db.ForeignKey('type.id'), nullable=False)  # Viittaus type-tauluun
    title = db.Column(db.String(255), nullable=False)
    author = db.Column(db.String(100), nullable=True)
    year = db.Column(db.Integer, nullable=True)

    # Valinnaiset kentät viitetyypeille
    ...
    # Suhde type-tauluun haun helpottamiseen
    type = db.relationship('Type', backref=db.backref('references', lazy=True))
